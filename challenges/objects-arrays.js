...
console.log(`The mighty T-Rex weighed a whopping ${tyrannosaurus.weight}!`);
...
console.log(`T-Rex lived during the ${tyrannosaurus.period} period.`);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(`My bro T-Rex has something to say...\n "${tyrannosaurus.sayWussup()}"`);
...
*/
const lowPopulation = zooAnimals.filter(headCount => {
